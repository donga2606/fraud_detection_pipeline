...
The main contribution of this project is the development of a pipeline-based system that makes the fraud detection workflow easier to execute and manage. Instead of training and evaluating models through scattered scripts or notebooks, the project organizes the process into a clear sequence of stages, including data preparation, model training, evaluation, hyperparameter sweep, and result comparison. This design improves usability, reproducibility, and experiment management, allowing users to run and review machine learning experiments more efficiently.
